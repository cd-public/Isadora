...
for reg in regs:
	...
	as_file.write("autogenerated_" + str(count).zfill(3) + "_" + reg + "_to_" + nt + ": assert iflow (\n")
	...
	# run tortuga
	system("./clean.sh")
	system("radixs_shell -s iACW_explore.script")
	system("./run_questa_explore")
	
	# refine it
	system("cp iACW.vcd ..")
	system("python refine_vcd.py")
	system("mv ../r_iACW.vcd ../" + reg + ".vcd")
